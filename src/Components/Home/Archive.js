            ...
            <div className='container my-24 px-6 mx-auto '>
                <div className='grid lg:grid-cols-2 gap-5 px-10'>
                    ...
                    <div>
                        ...
                        <div>
                            <button type="button" className="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Archive More..</button>
                        </div>
                    </div>
